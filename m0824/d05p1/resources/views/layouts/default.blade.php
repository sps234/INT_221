...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="./Heroes · Bootstrap v5.0_files/bootstrap.min.css" rel="stylesheet"
...
<button type="button" class="btn btn-outline-secondary btn-lg px-4">Secondary</button>
        ...
        *****************************************************************
        ...
        @include('layouts.includes.centered_hero')

        <div class="b-example-divider"></div>

        @include('layouts.includes.centered_screenshot')
...
<img src=".img3.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
        ...
        <div class="container my-5">
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
                ...
                <div class="col-lg-4 offset-lg-1 p-0 overflow-hidden shadow-lg">
                    <img class="rounded-lg-3" src="./Heroes · Bootstrap v5.0_files/bootstrap-docs.png" alt=""
                        width="720">
                </div>
            </div>
        </div>
    ...
    <script src="./Heroes · Bootstrap v5.0_files/bootstrap.bundle.min.js.download"
